...
.PHONY: help convert update-nav sync-docs preview clean all
...
help:
	...
	@echo "  sync-docs      Checkout and pull main branch in docs repo"
...
sync-docs:
	@echo "Syncing docs repo to main branch..."
	cd $(DOCS_DIR) && git checkout -f main && git pull
